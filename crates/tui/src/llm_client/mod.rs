...
//! # Architecture
//!
//! - `LlmClient` trait: Async interface for LLM providers (XiaomiMiMo, `OpenAI`, etc.)
...
///
/// This trait abstracts over different LLM APIs (XiaomiMiMo, `OpenAI`, etc.)
...
pub trait LlmClient: Send + Sync {
    /// Returns the provider name (e.g., "openai", "xiaomimimo")
