//! Whale/XiaomiMiMo terminal theme tokens.
//!
...
impl Theme {
    ...
    pub const fn dark() -> Self {
        Self {
            ...
            section_bg: palette::XIAOMIMIMO_INK,
            section_title_color: palette::XIAOMIMIMO_BLUE,
...
mod tests {
    ...
    fn dark_theme_matches_existing_palette_choices() {
        ...
        assert_eq!(theme.section_bg, palette::XIAOMIMIMO_INK);
        assert_eq!(theme.section_title_color, palette::XIAOMIMIMO_BLUE);
